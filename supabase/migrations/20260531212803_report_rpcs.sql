...
-- generate_report: atomically selects unlocked entries, enriches each with
-- user_full_name and category_name, inserts a reports row with the snapshot,
-- and locks all matched entries. Returns the new report's id.
